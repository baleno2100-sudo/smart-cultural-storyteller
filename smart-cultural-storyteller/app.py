...
# ======== Display Generated Story as Card ========
if st.session_state["story"]:
    ...
    <div class='story-card'>
        <h2 style='text-align:center; color:{accent_color}; font-size:20px; margin-bottom:6px;'>{story_title}</h2>
        {story_text.replace('\n','<br>')}
